...
CodeMirror.defineSimpleMode("automato", {
  ...
  start: [
    ...
    { regex: /infinity\S+|eternity\S+|reality\S+|doom\S+|armageddon\S+|pause\S+|restart\S+/ui, token: "error", next: "commandDone" },
    { regex: /infinity|eternity|reality|doom|armageddon/ui, token: "keyword", next: "prestige" },
