...
export class Sacrifice {
  ...
  static get nextBoost() {
    const nd1Amount = AntimatterDimension(1).amount.clampMax(Decimal.pow(10, 1e25)).pow(Decimal.pow(2, Math.log10(Decimal.log10(AntimatterDimension(1).amount) / 1e25)));
...
export function sacrificeReset() {
  ...
  player.sacrificed = player.sacrificed.plus(AntimatterDimension(1).amount.clampMax(Decimal.pow(10, 1e25)).pow(Decimal.pow(2, Math.log10(Decimal.log10(AntimatterDimension(1).amount) / 1e25))));
