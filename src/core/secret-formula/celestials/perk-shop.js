...
function rebuyable(config) {
  const { id, otherReq, cap, costCap, description, chargedEffect, formatEffect, formatCost, showEffectAfterCharge } = config;
  return {
    id,
    ...
    description,
    chargedEffect,
    effect: () => (player.celestials.teresa.charged.has(config.id)
